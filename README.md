...
## Results Preview (Patch 16.3 – Double Up)

Below are example outputs generated by the synergy pipeline.

### Top Synergy Score

![Top Synergy Score](assets/top_synergy_score.png)

The synergy_score combines:
- Empirical Bayes–shrunk performance
- Log-lift (interaction strength)
- Sample-size stabilization

---

### Top2 Lift (Observed vs Expected)

![Top Lift Top2](assets/top_lift_top2.png)

Lift > 1 indicates that the pair performs better together than predicted by marginal build strength alone.

---

### Empirical Bayes Stability (Games vs Performance)

![Scatter EB](assets/scatter_games_vs_eb_points.png)

This plot shows how Empirical Bayes shrinkage stabilizes small-sample estimates.

---

### Heatmap of Most Frequent Builds

![Heatmap](assets/heatmap_top_builds.png)

The heatmap visualizes average team performance (1–4 scale) across common build combinations.
